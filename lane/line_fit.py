...
def final_viz(undist, left_fit, right_fit, m_inv, left_curve, right_curve, vehicle_offset):
    ...
    label_str = '曲率半径: %.1f m' % avg_curve
    result = cv2AddChineseText(result, label_str, (30, 40), (0, 0, 255), 30)
    # result = cv2.putText(result, label_str, (30,40), 0, 1, (0,0,0), 2, cv2.LINE_AA)

    label_str = '载具偏离车道线中心: %.1f m' % vehicle_offset
    result = cv2AddChineseText(result, label_str, (30, 70), (0, 0, 255), 30)
